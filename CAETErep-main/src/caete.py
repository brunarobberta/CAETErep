...
class grd:
    ...
    def __init__(self, x, y, dump_folder):
        ...
        self.pr = None #Preciptation
        self.ps = None
        self.rsds = None
        self.tas = None #Air Temperature
        self.rhs = None
    ...
    def init_caete_dyn(self, input_fpath, stime_i, co2, pls_table, tsoil, ssoil, hsoil):
        ...
        self.pr = self.data['pr'] #Precipitation
        self.ps = self.data['ps']
        self.rsds = self.data['rsds']
        self.tas = self.data['tas'] #Air Temperature
...
class plot(grd):
    ...
    def init_plot(self, sdata, stime_i, co2, pls_table, tsoil, ssoil, hsoil):
        ...
        ## Reproduction
        self.vp_seed_bank_in = np.zeros(shape=(npls,), order='F')  ## NEW (module_reproduction)
